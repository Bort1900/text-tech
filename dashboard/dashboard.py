...
complete_query = f"SELECT B.asin, B.title, B.author, S.phrase, R.rating, S.polarity, B.genre, B.price, R.summary, R.review_text FROM books as B, reviews as R, sentiments as S WHERE B.asin = R.asin AND R.id = S.review_id {query_conditions}ORDER BY B.asin LIMIT 1000"
